  ...
  template:
    ...
    spec:
      ...
      - args:
        ...
        image: grc.azk8s.cn/google_containers/spartakus-amd64:v1.1.0
        name: volunteer
...
images:
- name: grc.azk8s.cn/google_containers/spartakus-amd64
  newName: grc.azk8s.cn/google_containers/spartakus-amd64
  newTag: v1.1.0
configMapGenerator:
