        ...
        - name: project
          valueFrom:
            configMapKeyRef:
              name: parameters
              key: project
        image: gcr.azk8s.cn/$(project)/profile-controller:latest
        ports:
        - containerPort: 2345
        securityContext:
          privileged: true
...
- params.yaml
images:
- name: gcr.azk8s.cn/$(project)/profile-controller
  newName: gcr.azk8s.cn/$(project)/profile-controller
  newTag: latest
`)
...
- name: gcr.azk8s.cn/kubeflow-images-public/kfam
  newName: gcr.azk8s.cn/kubeflow-images-public/kfam
  newTag: v1.0.0-gf3e09203
- name: gcr.azk8s.cn/kubeflow-images-public/profile-controller
  newName: gcr.azk8s.cn/kubeflow-images-public/profile-controller
