...
func writeApiServiceOverlaysExternalMysql(th *KustTestHarness) {
	th.writeF("/manifests/pipeline/api-service/overlays/external-mysql/config-map.yaml", `
...
func TestApiServiceOverlaysExternalMysql(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/pipeline/api-service/overlays/external-mysql")
	writeApiServiceOverlaysExternalMysql(th)
	...
	targetPath := "../pipeline/api-service/overlays/external-mysql"
	fsys := fs.MakeRealFS()
