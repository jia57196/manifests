  ...
  spawner_ui_config.yaml: |
    ...
    spawnerFormDefaults:
      image:
        ...
        options:
          - gcr.azk8s.cn/kubeflow-images-public/tensorflow-1.15.2-notebook-cpu:1.0.0
          - gcr.azk8s.cn/kubeflow-images-public/tensorflow-1.15.2-notebook-gpu:1.0.0
          - gcr.azk8s.cn/kubeflow-images-public/tensorflow-2.1.0-notebook-cpu:1.0.0
          - gcr.azk8s.cn/kubeflow-images-public/tensorflow-2.1.0-notebook-gpu:1.0.0
