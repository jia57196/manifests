...
spec:
  selector:
    matchLabels:
      ...
      app.kubernetes.io/instance: prometheus-v1.0.0
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - image: grc.azk8s.cn/stackdriver-prometheus/stackdriver-prometheus:release-0.4.2
...
- name: prometheus-parameters
  env: params.env
images:
- name: grc.azk8s.cn/stackdriver-prometheus/stackdriver-prometheus
  newName: grc.azk8s.cn/stackdriver-prometheus/stackdriver-prometheus
