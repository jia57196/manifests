...
func writeTektoncdDashboardBase(th *KustTestHarness) {
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: tekton-dashboard
        image: gcr.azk8s.cn/tekton-nightly/dashboard@sha256:e3e63e7a5e11a14927008cf61f6e6a1bfc36e9e13608e9c044570c162198f01d
        ports:
        - containerPort: 9097
        livenessProbe:
          httpGet:
...
images:
- name: gcr.azk8s.cn/tekton-nightly/dashboard
  newName: gcr.azk8s.cn/tekton-nightly/dashboard
  digest: sha256:e3e63e7a5e11a14927008cf61f6e6a1bfc36e9e13608e9c044570c162198f01d
`)
}

func TestTektoncdDashboardBase(t *testing.T) {
	th := NewKustTestHarness(t, "/manifests/tektoncd/tektoncd-dashboard/base")
	writeTektoncdDashboardBase(th)
	...
	targetPath := "../tektoncd/tektoncd-dashboard/base"
	fsys := fs.MakeRealFS()
